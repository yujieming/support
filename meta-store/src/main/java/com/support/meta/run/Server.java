...
import com.support.ratis.statemachine.StateMachinePropertiesConfigStateMachineRegistry;
...
public class Server {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (RaftPeer peer : Constants.PEERS) {
            ...
            BaseServer baseServer = new BaseServer(properties, new StateMachinePropertiesConfigStateMachineRegistry(stateMachineProperties -> {
                RocksConfigKeys.setRocksDir(stateMachineProperties, "rocks");
                RocksConfigKeys.setRocksPath(stateMachineProperties, storageDir.getPath());
            }));
